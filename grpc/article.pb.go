...
func (x *CreateArticleRequest) GetUsername() string {
	if x != nil {
		return x.Username
	}
	return ""
...
var file_article_proto_rawDesc = []byte{
	...
	0x04, 0x67, 0x72, 0x70, 0x63, 0x22, 0x20, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x42, 0x79, 0x49, 0x44,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x05, 0x52, 0x02, 0x69, 0x64, 0x22, 0x5c, 0x0a, 0x14, 0x43, 0x72, 0x65, 0x61, 0x74,
	...
	0x04, 0x74, 0x65, 0x78, 0x74, 0x22, 0x9d, 0x01, 0x0a, 0x07, 0x41, 0x72, 0x74, 0x69, 0x63, 0x6c,
	...
	,
...
var file_article_proto_goTypes = []interface{}{
	(*GetByIDRequest)(nil),       // 0: grpc.GetByIDRequest
	(*CreateArticleRequest)(nil), // 1: grpc.CreateArticleRequest
	(*Article)(nil),              // 2: grpc.Article
}
var file_article_proto_depIdxs = []int32{
	0, // 0: grpc.ArticleService.GetByID:input_type -> grpc.GetByIDRequest
	1, // 1: grpc.ArticleService.CreateArticle:input_type -> grpc.CreateArticleRequest
	2, // 2: grpc.ArticleService.GetByID:output_type -> grpc.Article
	2, // 3: grpc.ArticleService.CreateArticle:output_type -> grpc.Article
...
func (c *articleServiceClient) CreateArticle(ctx context.Context, in *CreateArticleRequest, opts ...grpc.CallOption) (*Article, error) {
	out := new(Article)
	err := c.cc.Invoke(ctx, "/grpc.ArticleService/CreateArticle", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ArticleService_CreateArticle_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpc.ArticleService/CreateArticle",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
